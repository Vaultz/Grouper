...
f_w = Array.new
f_w[0] = {:name => 'SQL_2016', :description => 'Création d\'un schéma de base de données, associé à un CRUD et des exemples de requêtes SQL ', :teacher => 'Hitcham', :begins => '16-09-2016', :ends => '20-01-2017', :teamnumber =>'4', :teamgeneration => 0, :created_at => '16-09-2016', :projectleaders => 0, :year => '2016'}
f_w[1] = {:name => 'SQL_2015', :description => 'Création d\'un schéma de base de données, associé à un CRUD et des exemples de requêtes SQL ', :teacher => 'Hitcham', :begins => '16-09-2015', :ends => '20-01-2016', :teamnumber =>'4', :teamgeneration => 0, :created_at => '16-09-2015', :projectleaders => 0, :year => '2015'}
f_w[2] = {:name => 'Devis_2016', :description => 'Éditer un devis pour un projet fictif avec M Ricard qui s\'amuse à jouer M.Fortineau', :teacher => 'Laurent', :begins => '20-09-2016', :ends => '16-10-2016', :teamnumber =>'3', :teamgeneration => 0, :created_at => '20-09-2016', :projectleaders => 1, :updated_at =>'20-09-2016', :year => '2016'}
f_w[3] = {:name => 'Devis_2015', :description => 'Éditer un devis pour un projet fictif avec M Ricard qui s\'amuse à jouer M.Fortineau', :teacher => 'Laurent', :begins => '20-09-2015', :ends => '16-10-2015', :teamnumber =>'3', :teamgeneration => 0, :created_at => '20-09-2015', :projectleaders => 1, :updated_at =>'20-09-2015', :year => '2015'}
f_w[4] = {:name => 'Ruby-on-Rails_2016', :description => 'Premier projet de développement en groupe, avec la technologie Ruby-on-Rails', :teacher => 'Kora', :begins => '25-09-2016', :ends => '25-10-2016', :teamnumber =>'3', :teamgeneration => 0, :created_at => '25-09-2016', :updated_at =>'25-09-2016', :projectleaders => 1, :year => '2016'}
f_w[5] = {:name => 'Ruby-on-Rails_2015', :description => 'Premier projet de développement en groupe, avec la technologie Ruby-on-Rails', :teacher => 'Kora', :begins => '25-09-2015', :ends => '25-10-2015', :teamnumber =>'3', :teamgeneration => 0, :created_at => '25-09-2015', :updated_at =>'25-09-2015', :projectleaders => 1, :year => '2015'}
